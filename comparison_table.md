...
| -- linked clef               | :white_check_mark: | :x:                | :x:                | :x:                                                  |
...
| --- explicit virga           | :x:                | :x:?               | :white_check_mark: | :x: no special conversion                            |
...
| - note spacing               | :white_check_mark: | :white_check_mark: | :x:                | :white_check_mark: converted all to zero width space |
| -- zero width space          | :white_check_mark: | :white_check_mark: | :x:                | :white_check_mark:                                   |
| -- normal space              | :white_check_mark: | :x:                | :x:                | :x: replaced with zero width space                   |
| -- factor space              | :white_check_mark: | :white_check_mark: | :x:                | :x: replaced with zero width space                   |
...
| - porrectus                  | implicit           | explicit           | explicit           | explicit                                             |
...
| -- virgula                   | :white_check_mark: | :white_check_mark: | :x:                | :white_check_mark:                                   |
| -- minimis bar               | :white_check_mark: | :white_check_mark: | :x:                | :white_check_mark:                                   |
| -- small bar                 | :white_check_mark: | :white_check_mark: | :x:                | :white_check_mark:                                   |
| -- maior bar                 | :white_check_mark: | :white_check_mark: | :x:                | :white_check_mark:                                   |
| -- finallis bar              | :white_check_mark: | :white_check_mark: | :x:                | :white_check_mark:                                   |
| -- minor bar                 | :white_check_mark: | :white_check_mark: | :x:                | :white_check_mark:                                   |
